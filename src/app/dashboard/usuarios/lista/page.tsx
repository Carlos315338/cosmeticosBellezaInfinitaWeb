...
export default function UsuariosListaPage() {
    ...
    const handleEliminarUsuario = async (id: string) => {
        ...
        try {
            await usuarioService.eliminacionUsuario(id);
            alert("Usuario eliminado exitosamente.");
            obtenerUsuariosPaginado(); // recarga la tabla
        } catch (error: any) {
                            ...
                            {usuarios.map((usuario) => (
                                <tr key={usuario.idUsuario}>
                                    <td className="text-center">
                                        ...
                                        <button onClick={() => handleEliminarUsuario(usuario.idUsuario)} className="btn btn-sm btn-outline-danger">🗑️</button>
                                    </td>
