...
export const rutasPorModulo: Record<Modulo, Ruta[]> = {
    ...
    categorias: [
        { nombre: "Categorías", ruta: "/dashboard/categorias" },
    ],
    proveedores: [
    ...
    ventas: [
        { nombre: "Registrar Ventas", ruta: "/dashboard/ventas/nuevo" },
    ],
    "cambiar-clave": [
        { nombre: "Cambiar Contraseña", ruta: "/dashboard/cambiar-clave" },
    ],
    finanzas: [
        { nombre: "Finanzas", ruta: "/dashboard/finanzas" },
    ],
    configuracion: [
